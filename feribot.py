...
admin=["u7cd68a1bc3cfa0ae3fcdb7907e4d307d"]
wait = {
    'contact':True,
    'autoJoin':False,
    ...
    try:
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
                ...
                if wait["atjointicket"] == False: md+=" Auto Join Group by Ticket : on\n"
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Command Hanya Untuk Grup")
                    else:
                        cl.sendText(msg.to,"Not for use less than group")
                ...
                if wait["clock"] == True:
                    ...
                    cl.sendText(msg.to, "Gua Lagi Byakugan Nih , Yang Sider Keliatan Cuk")
                    try:
...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    ki.sendText(msg.to,"Hai Grup Ini Akan Rata")
...
#-----------------------------------------------
            elif msg.text in ["welcome","Welcome","Wc"]:
                ki.sendText(msg.to,"Welcome In This Group")
#-----------------------------------------------
            elif msg.text in ["PING","Ping","ping"]:
                ki.sendText(msg.to,"PONG 􀨁􀄻double thumbs up􏿿􀜁􀅔Har Har􏿿")
#-----------------------------------------------
            elif msg.text in ["Respon","respon"]:
                ki.sendText(msg.to,"Ferians Bot")
#-----------------------------------------------
...
#------------------------------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    for tag in wait["blacklist"]:
                        matched_list+=filter(lambda str: str == tag, gMembMids)
                    if matched_list == []:
                        cl.sendText(msg.to,"You Are in Blacklist")
                        return
                    for jj in matched_list:
                        cl.kickoutFromGroup(msg.to,[jj])
                    cl.sendText(msg.to,"You in Blacklist Bitch , I Kick You")
